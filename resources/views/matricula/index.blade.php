    ...
    <div class="card-body">
        <form method="GET" action="{{ route('matricula.index') }}">
              ...
              <div class="row mt-1">
                  ...
                  <div class="col-sm">
                  <a href="{{ url('crear/alumnosmatricula/create') }}" class="btn btn-primary mt-0 ml-0 mr-0 btn-sm"style="float:right;"><i class="fas fa-plus-circle"></i> Matricular estudiante</a>
                  </div>
              </div>
            ...
            <thead class="thead-light">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @empty
					          <div class="alert alert-info">No se encontraron resultados en nuestros registros, por favor matricula al estudiante</div>
                </tr>
                @endforelse
              </tbody>
            </table>
